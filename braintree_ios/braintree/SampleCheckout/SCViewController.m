...
// Borrowed from here: https://github.com/braintree/braintree_ios/blob/master/braintree/SampleCheckout/SCViewController.m#L86
// Adjusted base url and parameter naming.
...
- (void) savePaymentInfoToServer:(NSDictionary *)paymentInfo {
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@/card/payment_method_code", SAMPLE_CHECKOUT_BASE_URL]];
