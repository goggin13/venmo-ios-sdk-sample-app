...
static ActivityOverlayView *sharedOverlayView = nil;

@interface ActivityOverlayView ()
...
+ (id)sharedOverlayView {
    if (!sharedOverlayView) {
        sharedOverlayView = [[ActivityOverlayView alloc] initWithTitle:@"Loading..."];
    }
